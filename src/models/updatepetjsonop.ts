...
export namespace UpdatePetJsonResponse$ {
    export const inboundSchema: z.ZodType<UpdatePetJsonResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdatePetJsonResponse> = z
        .object({
