...
export namespace UpdatePetFormResponse$ {
    export const inboundSchema: z.ZodType<UpdatePetFormResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdatePetFormResponse> = z
        .object({
