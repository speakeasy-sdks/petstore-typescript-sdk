...
export type AddPetJsonResponse = {
...
export namespace AddPetJsonResponse$ {
    export const inboundSchema: z.ZodType<AddPetJsonResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddPetJsonResponse> = z
        .object({
