...
export namespace CreateUserJsonResponse$ {
    export const inboundSchema: z.ZodType<CreateUserJsonResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateUserJsonResponse> = z
        .object({
