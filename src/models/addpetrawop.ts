...
export namespace AddPetRawResponse$ {
    export const inboundSchema: z.ZodType<AddPetRawResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddPetRawResponse> = z
        .object({
