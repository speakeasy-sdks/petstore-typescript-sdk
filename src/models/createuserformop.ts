...
export namespace CreateUserFormResponse$ {
    export const inboundSchema: z.ZodType<CreateUserFormResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateUserFormResponse> = z
        .object({
