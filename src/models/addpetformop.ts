...
export namespace AddPetFormResponse$ {
    export const inboundSchema: z.ZodType<AddPetFormResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddPetFormResponse> = z
        .object({
